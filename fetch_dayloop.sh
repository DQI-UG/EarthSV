...
echo 'Enter START date (yyyy.jdy)'
read start
...
time=`echo $time $add_time | awk '{print $1 + $2}'` #add 3600 seconds to the time ////// # 86400 for a Day loop ///////.
...
echo -e '##################\e[5mREADY\e[0m#\e[5mDATES\e[0m##########################'
